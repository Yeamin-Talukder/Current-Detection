...
@kotlin.Metadata(mv = {1, 9, 0}, k = 1, xi = 48, d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0004\bg\u0018\u00002\u00020\u0001J\u000e\u0010\u0002\u001a\u00020\u0003H\u00a7@\u00a2\u0006\u0002\u0010\u0004J\u0016\u0010\u0005\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0007H\u00a7@\u00a2\u0006\u0002\u0010\bJ\u0010\u0010\t\u001a\u0004\u0018\u00010\u0007H\u00a7@\u00a2\u0006\u0002\u0010\u0004J\u0010\u0010\n\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u000bH\'J\u0010\u0010\f\u001a\u0004\u0018\u00010\u0007H\u00a7@\u00a2\u0006\u0002\u0010\u0004J\u0010\u0010\r\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u000bH\'J\u0014\u0010\u000e\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00070\u000f0\u000bH\'J\u0014\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00070\u000fH\u00a7@\u00a2\u0006\u0002\u0010\u0004J$\u0010\u0011\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00070\u000f0\u000b2\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0013H\'J\u0016\u0010\u0015\u001a\u00020\u00132\u0006\u0010\u0006\u001a\u00020\u0007H\u00a7@\u00a2\u0006\u0002\u0010\bJ\u0016\u0010\u0016\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0007H\u00a7@\u00a2\u0006\u0002\u0010\b\u00a8\u0006\u0017"}, d2 = {"Lcom/currentdetection/data/local/PowerEventDao;", "", "clearAllEvents", "", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "deleteEvent", "event", "Lcom/currentdetection/data/local/entities/PowerEventEntity;", "(Lcom/currentdetection/data/local/entities/PowerEventEntity;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "getActiveGapEvent", "getActiveGapEventFlow", "Lkotlinx/coroutines/flow/Flow;", "getActiveOutageEvent", "getActiveOutageEventFlow", "getAllEvents", "", "getAllEventsList", "getEventsInRange", "startTime", "", "endTime", "insertEvent", "updateEvent", "app_debug"})
@androidx.room.Dao()
public abstract interface PowerEventDao {
     ...
     */
    @androidx.room.Query(value = "SELECT * FROM power_events WHERE endTime IS NULL AND isUnknownGap = 0 ORDER BY startTime DESC LIMIT 1")
     ...
     */
    @androidx.room.Query(value = "SELECT * FROM power_events WHERE endTime IS NULL AND isUnknownGap = 1 ORDER BY startTime DESC LIMIT 1")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getActiveGapEvent(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super com.currentdetection.data.local.entities.PowerEventEntity> $completion);
    ...
    @androidx.room.Query(value = "SELECT * FROM power_events WHERE endTime IS NULL AND isUnknownGap = 1 ORDER BY startTime DESC LIMIT 1")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<com.currentdetection.data.local.entities.PowerEventEntity> getActiveGapEventFlow();
